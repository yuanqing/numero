...
test('parseFloat', function(t) {
  ...
  t.equals(fn(3.14), 3.14, 'number float');
  t.equals(fn(-3.14), -3.14, 'number negative float');
  t.equals(fn(3e14), 3e14, 'number exponent');
  t.equals(fn(-3e14), -3e14, 'number negative exponent');
  t.equals(fn(Number.MIN_VALUE), Number.MIN_VALUE, 'Number.MIN_VALUE');
  ...
  t.equals(fn('3.14'), 3.14, 'string float');
  t.equals(fn('.314'), 0.314, 'string float');
  t.equals(fn('-3.14'), -3.14, 'string negative float');
